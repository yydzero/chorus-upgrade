...
describe BoxplotSummary do
  it "should handle a 1 row data set" do
    ...
    BoxplotSummary.summarize(input, nil).should =~[{:bucket => 'apple',
                                               :min => 1, :first_quartile => 1, :median => 1, :third_quartile => 1, :max => 1, :percentage => "100.00%", :count => 1}]
  end
  ...
  it "should handle a 2 row data set" do
    ...
    BoxplotSummary.summarize(input, nil).should =~[{:bucket => 'apple',
                                               :min => 1, :first_quartile => 1.25, :median => 1.5, :third_quartile => 1.75, :max => 2, :percentage => "100.00%", :count => 2}]
  end
  ...
  it "should handle a 3 row data set" do
    ...
    BoxplotSummary.summarize(input, nil).should =~[{:bucket => 'apple',
                                               :min => 1, :first_quartile => 1.5, :median => 2, :third_quartile => 2.5, :max => 3, :percentage => "100.00%", :count => 3}]
  end
  ...
  it "should handle a 4 row data set" do
    ...
    BoxplotSummary.summarize(input, nil).should =~[{:bucket => 'apple',
                                               :min => 0, :first_quartile => 1.5, :median => 3.5, :third_quartile => 5.5, :max => 7, :percentage => "100.00%", :count => 4}]
  end
  ...
  it "handles two categories" do
    ...
    BoxplotSummary.summarize(input, nil).should =~[{:bucket => 'banana', :min => 0, :first_quartile => 1.5, :median => 3.5, :third_quartile => 5.5, :max => 7, :percentage => "57.14%", :count => 4},
                                                  {:bucket => 'apple', :min => 1, :first_quartile => 1.5, :median => 2, :third_quartile => 2.5, :max => 3, :percentage => "42.86%", :count => 3}
                                                  ]
  end
  ...
  it "should handle when bins are set" do
    ...
    BoxplotSummary.summarize(input, 1).should =~[{:bucket => 'banana', :min => 0, :first_quartile => 1.5, :median => 3.5, :third_quartile => 5.5, :max => 7, :percentage => "57.14%", :count => 4}]
  end
end